...
minBtn.TextSize = 18
minBtn.BackgroundColor3 = Color3.fromRGB(99, 99, 99)
...
minus.TextSize = 22
minus.BackgroundColor3 = Color3.fromRGB(17, 255, 255)
...
spLabel.TextSize = 16
spLabel.TextColor3 = Color3.fromRGB(0, 0, 0)
...
plus.TextSize = 22
plus.BackgroundColor3 = Color3.fromRGB(0, 255, 72)
plus.BorderSizePixel = 0

-- Fly toggle
local flyBtn = makeRow("🕊️ Bay: TẮT")
flyBtn.Name = "FlyBtn"
flyBtn.LayoutOrder = 5
flyBtn.Parent = scroll
local flyStatus = statusLabel(flyBtn, "OFF")
...
flyBtn.MouseButton1Click:Connect(function()
	...
	flyStatus.Text = state.fly and "ON" or "OFF"
	flyBtn.Text = "🕊️ Bay: " .. (state.fly and "BẬT" or "TẮT")
end)
